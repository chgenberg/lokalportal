...
export default function ImageCropModal({ open, imageFile, onClose, onCropped }: ImageCropModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-4 bg-white rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="p-4 border-t border-border/60 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <span className="text-[12px] text-gray-500">Zoom</span>
            <input
              type="range"
              min={1}
              max={3}
          ...
          <div className="flex gap-2">
            <button type="button" onClick={onClose} className="px-4 py-2.5 text-[13px] font-medium text-gray-500 hover:text-navy border border-border/60 rounded-xl transition-colors">
              Avbryt
            </button>
