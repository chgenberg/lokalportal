          ...
          <div className="relative rounded-3xl overflow-hidden min-h-[380px] grain-overlay">
            ...
            <div className="relative z-10 min-h-[320px] flex flex-col items-center justify-center px-6 py-12 sm:px-8 sm:py-16 md:px-16 md:py-24 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 flex-wrap">
                <Link href="/logga-in" className="inline-flex items-center gap-2 px-8 py-3.5 bg-gold text-navy font-semibold rounded-xl text-sm tracking-wide transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                  Logga in med BankID
                </Link>
