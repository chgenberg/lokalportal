      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-muted rounded-xl text-sm border border-border focus:border-accent focus:ring-1 focus:ring-accent outline-none transition-colors"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-3 bg-muted rounded-xl text-sm border border-border focus:border-accent focus:ring-1 focus:ring-accent outline-none transition-colors pr-12"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full flex items-center justify-center gap-2 py-3.5 bg-navy text-white text-sm font-semibold rounded-xl hover:bg-navy-light transition-colors disabled:opacity-50"
          >
            {submitting ? (
        ...
        <div className="mt-8 pt-6 border-t border-border">
          <p className="text-xs text-gray-400 text-center">
            ...
            <Link href="/villkor" className="text-accent hover:underline">
              villkor
            </Link>{" "}
            och{" "}
