      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    {input.outdoorImageUrl ? (
                      ...
                      <div className="flex flex-col items-center gap-2">
                        <svg className="w-8 h-8 text-gray-300 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3.75 21h16.5A2.25 2.25 0 0022.5 18.75V5.25A2.25 2.25 0 0020.25 3H3.75A2.25 2.25 0 001.5 5.25v13.5A2.25 2.25 0 003.75 21z" />
                        </svg>
                        <span className="py-2 px-4 bg-navy text-white text-[12px] font-semibold rounded-lg pointer-events-none">Ladda upp bild</span>
                        <span className="text-[11px] text-gray-400 pointer-events-none">eller dra & släpp</span>
                      </div>
                    )}
                  </div>
                  <div
                  ...
                  >
                    ...
                    {input.floorPlanImageUrl ? (
                      ...
                      <div className="flex flex-col items-center gap-2">
                        <svg className="w-7 h-7 text-gray-300 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
                        </svg>
                        <span className="py-2 px-4 bg-muted/80 text-navy text-[12px] font-semibold rounded-lg pointer-events-none">Ladda upp planlösning</span>
                        <span className="text-[11px] text-gray-400 pointer-events-none">eller dra & släpp</span>
                      </div>
                    )}
                  </div>
                  ...
                  >
                    ...
                    {input.videoUrl ? (
                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <span className="py-2 px-4 bg-muted/80 text-navy text-[12px] font-semibold rounded-lg pointer-events-none">Ladda upp video</span>
                        <span className="text-[11px] text-gray-400 pointer-events-none">eller dra & släpp</span>
                      </div>
                    )}
                  </div>
        ...
        {step === "preview" && generated && (
          <div className="animate-fade-in space-y-6">
            ...
            {(generated.demographics || generated.nearby || generated.areaContext) && (
