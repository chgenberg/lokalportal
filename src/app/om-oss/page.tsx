...
export const metadata: Metadata = {
  ...
  description: "Möt Göran Ytström och teamet bakom Hittayta.se – Sveriges modernaste marknadsplats för kommersiella lokaler.",
};
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="bg-navy relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 text-center">
          ...
          <p className="text-white/50 text-[15px] max-w-lg mx-auto leading-relaxed">
            Bakom Hittayta.se står Göran Ytström – mannen som kan lukta sig till en bra lokal på 500 meters avstånd.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl border border-border/40 p-8 shadow-sm mb-6">
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-navy mb-1 tracking-tight">Göran Ytström</h2>
              ...
              <p className="text-[15px] text-gray-600 leading-relaxed">
                Göran har jobbat med kommersiella lokaler i över 25 år. Det hela började 1998 när han av misstag hyrde ut sitt garage till en startup som behövde &ldquo;ett litet kontor med karaktär&rdquo;. Startupen gick under efter tre månader, men Göran hade hittat sin livs passion: att matcha rätt lokal med rätt människa.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Görans resa */}
        <div className="bg-white rounded-2xl border border-border/40 p-8 shadow-sm mb-6">
          <p className="text-[11px] font-semibold text-gray-400 tracking-[0.15em] uppercase mb-3">Görans resa</p>
            ...
            {[
              {
                ...
                text: "Göran hyr ut sitt garage i Mölndal. Hyresgästen klagar på att det luktar motorolja. Göran svarar: \"Det är karaktär.\" En bransch-legend föds.",
              },
              {
                year: "2003",
                title: "500 lokaler och en insikt",
                text: "Efter att ha förmedlat sin 500:e lokal inser Göran att han kan uppskatta en lokals yta med blotta ögat, med max 2 m² felmarginal. Hans fru är mindre imponerad än han hade hoppats.",
              },
              {
                year: "2012",
                title: "\"Det måste finnas ett bättre sätt\"",
                text: "Göran sitter i sin bil utanför en lokal i Västerås och scrollar genom PDF:er i sin mejl. Han bestämmer sig: lokalmarknaden behöver digitaliseras. Hans tonårsdotter förklarar vad en app är.",
              },
              {
                year: "2024",
                title: "Hittayta.se lanseras",
                text: "Efter år av research, prototyper och alldeles för mycket kaffe lanseras Hittayta.se – med AI-genererade annonser, kartvisning och Görans personliga kvalitetsstämpel på varje funktion.",
              },
            ].map((item) => (
        ...
        {/* Fun facts */}
        <div className="bg-white rounded-2xl border border-border/40 p-8 shadow-sm mb-6">
          <p className="text-[11px] font-semibold text-gray-400 tracking-[0.15em] uppercase mb-3">Saker du inte visste om Göran</p>
        ...
        <div className="bg-white rounded-2xl border border-border/40 p-8 shadow-sm mb-6">
          ...
          <p className="text-[15px] text-gray-600 leading-relaxed">
            Göran brukar säga: <em>&ldquo;En bra lokal kan förändra ett företag. En dålig plattform ska inte stå i vägen.&rdquo;</em> Vi håller med honom. Mest för att han är chefen.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          {[
            { title: "Transparens", text: "Inga dolda avgifter, inga överraskningar. Förutom att Göran ibland dyker upp med tårta.", icon: "🔍" },
            { title: "Enkelhet", text: "Från sökning till kontrakt – allt ska vara så smidigt att till och med Göran klarar det.", icon: "✨" },
        ...
        <div className="bg-navy/[0.03] rounded-2xl border border-navy/10 p-8 mb-6 text-center">
          ...
          <p className="text-[13px] font-semibold text-navy">Göran Ytström</p>
          <p className="text-[12px] text-gray-400">Grundare, Hittayta.se</p>
        </div>

        {/* CTA */}
        <div className="bg-navy rounded-2xl p-8 text-center">
          <h2 className="text-xl font-bold text-white mb-2 tracking-tight">Vill du prata lokaler med Göran?</h2>
